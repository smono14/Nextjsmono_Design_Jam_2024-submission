      ...
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[750px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div>
            ...
            <p className="mb-6">
            We are proud to offer worldwide shipping, delivering our products to
             customers across the globe. Our goal is to provide fast, reliable, and affordable shipping, 
            ensuring a seamless shopping experience no matter where you are.
            </p>

            <p className="mb-6">
            We ship to most countries, including the United States, Canada, the United Kingdom, Europe, Australia, UAE, India, and many more. However, certain remote areas or regions with shipping restrictions may have limited service.
            </p>

            <p>
            We offer multiple shipping options to cater to your needs. Standard shipping typically takes between 7-14 business days, depending on your location, while express shipping delivers your order within 3-7 business days via premium couriers such as DHL, FedEx, and UPS. 
            </p>
            ...
            <div className="rounded-xl bg-white pt-7.5 pb-6 px-4 sm:px-7.5 my-7.5">
              ...
              Shipping costs are calculated based on your location, order weight, and selected shipping method. To make shopping more convenient, we offer free shipping on orders above $100
              </p>
            ...
            <p className="mb-6">
            Once your order is processed and shipped, you will receive a tracking number to monitor its progress. Please note that delivery times may vary due to factors such as customs clearance and local postal services..
            </p>

            <p className="mb-6">
            We provide real-time tracking for all international shipments. Once your order has been dispatched, you will receive an email with a tracking link to monitor your shipment's status.
            </p>

            <p className="mb-6">
            For international orders, customs duties and taxes may apply based on your country’s import regulations. These charges are determined by local customs authorities and are the responsibility of the customer. Some regions provide Delivered Duty Paid (DDP) options, where duties and taxes are calculated upfront at checkout, ensuring no unexpected charges upon delivery. Please check your country’s customs policies before placing an order.
            </p>

            <p>
            We want you to shop with confidence, which is why we offer a 30-day return policy for most items. If you are not satisfied with your purchase, you can return the product for a refund or exchange.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-between gap-10 mt-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="https://www.linkedin.com/in/mohib-works-188ab9336/"
